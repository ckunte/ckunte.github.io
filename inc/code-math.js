function loadSyntaxAndMathOnDemand() {
  ...
  if (needsHighlight && needsKatex) {
    ...
    loadCSS('https://cdnjs.cloudflare.com/ajax/libs/github-markdown-css/5.5.1/github-markdown.min.css'); // Optional: for better code block styling
    ...
    loadCSS('https://cdnjs.cloudflare.com/ajax/libs/github-markdown-css/5.5.1/github-markdown.min.css');
    loadScript('https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/highlight.min.js', () => {
      hljs.highlightAll();
    });
  } else if (needsKatex) {
